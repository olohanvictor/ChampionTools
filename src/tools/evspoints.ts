import { convertEVsToPoints, convertPointsToEVs } from "../core/points.ts"
...
const ANSWER_ME = document.getElementById("btnAnswer") as HTMLButtonElement
...
ANSWER_ME.addEventListener("click", () => {
